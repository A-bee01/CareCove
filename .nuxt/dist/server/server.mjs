...
import { TbdexHttpClient, Rfq, Close, Order } from "@tbdex/http-client";
import "@web5/dids";
import { PresentationExchange, Jwt } from "@web5/credentials";
if (!globalThis.$fetch) {
...
async function applyPlugins(nuxtApp, plugins2) {
  ...
  async function executePlugin(plugin2) {
    const unresolvedPluginsForThisPlugin = plugin2.dependsOn?.filter((name) => plugins2.some((p) => p._name === name) && !resolvedPlugins.includes(name)) ?? [];
...
const _routes = [
  {
    name: "credentials",
    path: "/credentials",
    component: () => import("./_nuxt/credentials-YVv3Rzer.js").then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import("./_nuxt/dashboard-DIUUiweb.js").then((m) => m.default || m)
  },
  {
    name: "donate",
    path: "/donate",
    component: () => import("./_nuxt/donate-DwtNW56d.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-95VBSFA5.js").then((m) => m.default || m)
  }
];
...
const prerender_server_LXx1wM9sKF = /* @__PURE__ */ defineNuxtPlugin(async () => {
  ...
  routes || (routes = Array.from(processRoutes(([__temp, __restore] = executeAsync(() => routerOptions.routes?.(_routes)), __temp = await __temp, __restore(), __temp) ?? _routes)));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-PCDDDODX.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CDzEpaJF.js").then((r) => r.default || r));
