...
const _routes = [
  {
    name: "credentials",
    path: "/credentials",
    component: () => import('./credentials-YVv3Rzer.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-DIUUiweb.mjs').then((m) => m.default || m)
  },
  {
    name: "donate",
    path: "/donate",
    component: () => import('./donate-DwtNW56d.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-95VBSFA5.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-PCDDDODX.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CDzEpaJF.mjs').then((r) => r.default || r));
