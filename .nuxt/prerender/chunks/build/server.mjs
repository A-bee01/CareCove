...
const _routes = [
  ...
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-D3v4ZQog.mjs').then((m) => m.default || m)
  },
  {
    name: "donate",
    path: "/donate",
    component: () => import('./donate-PGZVusFj.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-DKeKMkyq.mjs').then((m) => m.default || m)
  }
];
...
export { useStore as a, useRouter as b, navigateTo as c, useNuxtApp as d, entry$1 as default, useRuntimeConfig as e, firebaseApp as f, nuxtLinkDefaults as n, resolveRouteObject as r, useHead as u };
