<template>
  <div class="flex flex-col min-h-screen">
    ...
    <main class="flex-1 bg-[#ffffff] dark:bg-[#ffffff] py-8 px-6 md:px-8">
      <div
        class="max-w-3xl mx-auto bg-white dark:bg-[#10673b] rounded-lg shadow p-6"
      >
        ...
        <div class="mt-4">
          <button
            ...
            class="inline-flex items-center justify-center rounded-md text-sm font-medium bg-red-500 text-white hover:bg-red-600 h-10 px-4 py-2"
          >
