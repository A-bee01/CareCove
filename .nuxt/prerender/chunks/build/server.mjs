...
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/ikechukwuokafor/Downloads/CareCove/node_modules/vue-router/dist/vue-router.node.mjs';
...
import { getFirestore } from 'file:///Users/ikechukwuokafor/Downloads/CareCove/node_modules/firebase/firestore/dist/index.mjs';
...
const _routes = [
  {
    name: "credentials",
    path: "/credentials",
    component: () => import('./credentials-BBlf5_PF.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./dashboard-CpjemsM2.mjs').then((m) => m.default || m)
  },
  {
    name: "donate",
    path: "/donate",
    component: () => import('./donate-B_ww1EBs.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-Bq8eJL-w.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BoQy3GOP.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-DDszwGTR.mjs').then((r) => r.default || r));
...
export { useRouter as a, navigateTo as b, useNuxtApp as c, useRuntimeConfig as d, entry$1 as default, db as e, nuxtLinkDefaults as n, resolveRouteObject as r, useHead as u };
