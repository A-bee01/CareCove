...
const _routes = [
  {
    name: "credentials",
    path: "/credentials",
    component: () => import("./_nuxt/credentials-DjASd8tf.js").then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import("./_nuxt/dashboard-CRHNVsus.js").then((m) => m.default || m)
  },
  {
    name: "donate",
    path: "/donate",
    component: () => import("./_nuxt/donate-Itpw1yNl.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-BIwPWivB.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BcSjj8m5.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-l4Nj-vD8.js").then((r) => r.default || r));
