...
const _routes = [
  {
    name: "credentials",
    path: "/credentials",
    component: () => import("./_nuxt/credentials-BBlf5_PF.js").then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import("./_nuxt/dashboard-CpjemsM2.js").then((m) => m.default || m)
  },
  {
    name: "donate",
    path: "/donate",
    component: () => import("./_nuxt/donate-B_ww1EBs.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-Bq8eJL-w.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BoQy3GOP.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DDszwGTR.js").then((r) => r.default || r));
